    ...
    public partial class Form1 : Form
    {
        ...
        private void ShowAvatar(string imageName)
        {
            ...
            else
            {
                ...
                {
                    MessageBox.Show($"Error loading the image: {ex.Message}", "Image Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    picAvatar.Image = null;
                }
            }
        }
        ...
        {
            if (string.IsNullOrWhiteSpace(filepath) || picAvatar.Image == null) return;

            string fileName = $"{tbMa.Text}.jpg";
            var destinationPath = Path.Combine(Application.StartupPath, "Images", fileName);
            //picAvatar.Image.Save(destinationPath, ImageFormat.Jpeg);
            picAvatar.Image.Save(@"C:\Users\Admin\OneDrive\Máy tính\Lab05\Lab05.GUI\Images");
